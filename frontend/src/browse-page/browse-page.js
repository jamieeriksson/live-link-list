...
function SearchBar(props) {
  ...
  return (
    <div className="mt-4 mb-24 shadow-lg">
      <form onSubmit={handleSubmit} className="flex">
        ...
        <input
          ...
          className="px-2 md:px-4 py-1 md:py-2 flex place-items-center flex-grow bg-gray-50 border-t border-b border-l rounded-l-md md:rounded-none border-gray-200 focus:outline-none"
        />
...
export default function BrowsePage() {
  ...
  if (state.status === "error") {
    return (
      ...
      >
        <div className="px-3 max-w-4xl w-full">
          <SearchBar
            query={query}
